...
PLAYERS_INPUT_QUEUE_NAME = JOIN_REDUCERS_TO_GROUP_BY_CIV_MASTER_QUEUE_NAME
OUTPUT_EXCHANGE_NAME = GROUP_BY_CIV_MASTER_TO_REDUCERS_EXCHANGE_NAME
KEYS_QUEUE_NAME = GROUP_BY_CIV_MASTER_TO_REDUCERS_QUEUE_NAME
BARRIER_QUEUE_NAME = GROUP_BY_CIV_REDUCERS_BARRIER_QUEUE_NAME
REDUCERS_OUTPUT_QUEUE_NAME = GROUP_BY_CIV_REDUCERS_TO_WINNER_RATE_CALCULATOR_QUEUE_NAME
