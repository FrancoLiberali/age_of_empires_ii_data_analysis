...
CLIENTS_RESPONSES_EXCHANGE_NAME = 'clients_responses_exchange'
...
CLIENT_REQUEST_RESPONSE_QUEUE_NAME_INDEX = 0
CLIENT_REQUEST_TYPE_INDEX = 1
CLIENT_REQUEST_TYPE_AUTHORIZE = 'authorization'
CLIENT_REQUEST_TYPE_QUERY = 'query'

CLIENT_QUERY_REQUEST_DATASET_TOKEN_INDEX = 2

AUTHORIZE_RESPONSE_AUTHORIZATION_INDEX = 0
AUTHORIZE_RESPONSE_DATASET_TOKEN_INDEX = 1
AUTHORIZED_CODE = 'AUTHORIZED'
UNAUTHORIZED_CODE = 'UNAUTHORIZED'

QUERY_RESPONSE_STATE_INDEX = 0
DATASET_FINISHED_CODE = 'FINISHED'
DATASET_BEING_PROCESSED_CODE = 'BEING_PROCESSED'
DATASET_NOT_FOUND_CODE = 'NOT_FOUND'
QUERY_RESPONSE_RESULTS_INDEX = 1
QUERY_RESPONSE_RESULTS_OUTPUT_SEPARATOR = "OUTPUT_FINISH"
