...
docker-compose -f docker-compose-client-and-servers.yaml up -d --scale join_reducer_1v1=$1 --scale join_reducer_team=$1 --scale group_by_civ_reducer_1v1=$1 --scale group_by_civ_reducer_team=$1 --scale group_by_match_reducer=$1
