...
{results_by_output[1]}""")
            logger.info(f"""Porcentaje de victorias por civilización en partidas 1v1(ladder == RM_1v1) con civilizaciones diferentes en mapa arena son:
{results_by_output[2]}""")
            logger.info(f"""Top 5 civilizaciones más usadas por pro players(rating > 2000) en team games (ladder == RM_TEAM) en mapa islands son:
{results_by_output[3]}""")
